...
KEY_START_TIME_ENTRY=$(get_tmux_option "@tmux-toggl-start-time-entry-key" "t")
...
tmux bind-key "$KEY_START_TIME_ENTRY" display-popup -E "$CURRENT_DIR/scripts/start_time_entry.sh"
...
toggl_commands=(
  "#(flock -n .tmux-toggl-logged-month.lock $CURRENT_DIR/scripts/logged_month.sh)"
  "#(flock -n .tmux-toggl-logged-day.lock $CURRENT_DIR/scripts/logged_day.sh)"
  "#(flock -n .tmux-toggl-projected-hours.lock $CURRENT_DIR/scripts/projected_hours.sh)"
)
