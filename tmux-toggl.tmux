...
KEY_START_TIME_ENTRY=$(get_tmux_option "@tmux-toggl-start-time-entry-key" "N")
...
tmux bind-key "$KEY_START_TIME_ENTRY" run-shell "$CURRENT_DIR/scripts/start_time_entry.sh"
